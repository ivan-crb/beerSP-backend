...
class CervezaControllerTest {
    ...
    class ObtenerCervezasTests {
        ...
        void obtenerCervezas_ok() throws Exception {
            List<Cerveza> cervezas = Arrays.asList(
                    new Cerveza(1, "Cerveza1","foto1", "descripción1","estilo1","procedencia1","tamaño1","formato1", 1, 1, "color1"),
                    new Cerveza(2, "Cerveza2","foto2", "descripción2","estilo2","procedencia2","tamaño2","formato2", 2, 2, "color2")
            );
    ...
    class ObtenerCervezaTests {
        ...
        void obtenerCerveza_existente() throws Exception {
            Cerveza cerveza = new Cerveza(1, "Cerveza1","foto1", "descripción1","estilo1","procedencia1","tamaño1","formato1", 1, 1, "color1");
    ...
    class CrearCervezaTests {
        ...
        void crearCerveza() throws Exception {
            Cerveza nueva = new Cerveza(3, "Cerveza3","foto3", "descripción3","estilo3","procedencia3","tamaño3","formato3", 3, 3, "color3");
            Cerveza creada = new Cerveza(10, "Cerveza10","foto10", "descripción10","estilo10","procedencia10","tamaño10","formato10", 10, 10, "color10");
    ...
    class ActualizarCervezaTests {
        ...
        @DisplayName("Debe actualizar y retornar 204")
        void actualizar_ok() throws Exception {
            Cerveza mod = new Cerveza(1, "Cerveza1","foto1", "amarga en exceso","estilo1","procedencia1","tamaño1","formato1", 1, 1, "color1");
